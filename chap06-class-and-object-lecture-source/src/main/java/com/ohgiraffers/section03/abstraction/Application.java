...
public class Application {
    ...
    public static void main(String[] args) {
         ...
         * 객체 지향 프로그래밍이란
         *
         * 현실 세계의 모든 사건(event)은 객체와 객체의 상호작용에 의해 일어난다는 세계관을
         ...
         * 또한 하나의 객체는 너무 많은 일을 수행하는 것이 아닌 적절한 책임을 가지고 있어야 한다. => 단일책임의 법칙
         * */

        /*
         * 객체를 설계하기 위해서는 현실 세계를 그대로 반영하기에는 너무 방대하고 복잡하기 때문에
         ...
         * 이 때, 메세지(메소드)를 보내는 쪽은 송신자, 메세지를 수신하는 쪽을 수신자라고 한다.
         ...
         *
         * 2. 객체 간 상호작용
         * 1) 카레이서가 수신할 수 있는 메세지(카레이서가 해야 하는 일) ->자동차를 움직이게 해야 함.
         *   - 시동을 걸어라
         *   -엑셀레이터를 밟아라
         *   -브레이크를 밟아라
         *   -시동을 꺼라
