...
public class C_IfElseIf {
    ...
    public void testSimpleIfElseStatement() {
        System.out.println("산 속에서 나무를 하던 나무꾼이 연못에 도끼를 빠뜨리고 말았디.");
        ...
        if (answer == 1) {
            System.out.println("거짓말쟁이 아무런 도끼도 줄 수 없다.");
        } else if (answer == 2) {
            System.out.println("욕심이 과하지는 않으나 거짓말을 했구나.");
        } else if (answer == 3) {
            System.out.println("정직하구나 다 가져가라");
        } else {
