...
public class Application1 {
    public static void main(String[] args) {
         ...
         * 자바에서 컬렉션 프레임워크는 여러 개의 다양한 데이터들을 쉽고 효율적으로 처리할 수 있도록
         * 표준화된 방법을 제공하는 클래스들의 집합이다.
         * => 데이터를 효율적으로 저장하는 자료구조와 데이터를 처리하는 알고리즘을 미리 구현해놓은 클래스
         * */

        /*
         * Collection FarmWork 는 크게 3가지 인터페이스 중 한 가지를 상속 받아 구현해 두었다.
         * 1. List 인터페이스
         * 2. Set 인터페이스
         * 3. Map 인터페이스
         *
         * List 인터페이스와 Set 인터페이스와 공통 부분을 collection 인터페이스에서 정의
         * 하지만 Map은 구조 상의 차이로 Collection 인터페이스에서 정의되지 않음.
         * */
         ...
         * 배열의 단점 : 크기 변경 불가, 요소의 추가, 수정, 삭제, 정력 복잡함
        ...
        * Collections 클래스를 사용 -> Collection 사용되는 기능을 static 메소드로 구현한 클래스
        * */
        ...
        *
        * hashNext() : 다음 요소를 가지고 있는 경우 true, 더 이상 요소가 없는 경우 false 반환
        * next() : 다음요소를 반환
        * */
