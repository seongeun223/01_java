...
public class Application2 {
    public static void main(String[] args) {
        ...
        //이 때 값의 형태에 따라 사용할 수 있는 연산자의 종류와 연산의 결과 달라진다.
        ...
        System.out.println("seongeun" + 123); //정수와의 연산
        System.out.println("seongeun" + 123.456); //실수와의 연산
        System.out.println("seongeun" + 'a'); //문자와의 연산
        System.out.println("seongeun" + true); //논리값과의 연산
        ...
        //논리값과 정수의 연산도 마찬가지로 안 됩니다.
        //논리값과 실수의 연산도 마찬가지로 X
        //논리값과 문자의 연산도 X
        //논리값과 문자열의 연산
