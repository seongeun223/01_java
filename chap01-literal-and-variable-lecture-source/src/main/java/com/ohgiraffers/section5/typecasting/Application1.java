...
public class Application1 {
    public static void main(String[] args) {
        ...
        * */
        ...
        //int result = num1 + num2; // long으로 변경해서 연산이 되기 때문에 int로 선언된 변수에 값을 담을 수 없다.
        ...
        * */
        ...
        /* int로 type이 명시적으로 정해지지 않은 리터럴형태의 정수는 char형 변수에 기록 가능하다. */
        char ch2 = 65;
