    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        try {
            ...
            * 최초 실행 시 새롭게 파일이 만들어지기 때문에 true 반환,
            * 한 번 생성되고난 이후에는 새롭게 파일이 생성되지 않기 때문에 false를 반환.
            * */
            boolean isCrate = file.createNewFile();

            System.out.println("파일이 생성되었습니다. : " + isCrate);
