...
public class Application2 {
    public static void main(String[] args) {
        ...
        * */
        ...
        System.out.println("char2 : " + carr2);
        System.out.println("larr : " + larr);

        /*
        * hashcode() : 일반적으로 객체의 주소값을 10진수로 변환하여 생성한 객체의 고유한 정수값은 반환
        ...
        * */
        ...
        System.out.println("char2의 길이 : " + carr2.length);

        Scanner sc = new Scanner(System.in);

        System.out.println("새로 할당 배열의 길이를 입력하세요 : ");
        int size =sc.nextInt();

        double[] darr = new double[size];

        System.out.println("darr의 hashcod : " + darr.hashCode());
        ...
        // 배열의 사이즈를 변경한 것이 아니고, 새로운 배열을 생성해서 그 주소값을 레퍼런스 변수에 덮어쓴 것이다.
        System.out.println("변경된 darr의 hashcod : " + darr.hashCode());
