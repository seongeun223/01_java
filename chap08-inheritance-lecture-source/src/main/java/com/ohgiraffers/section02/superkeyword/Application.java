...
public class Application {
    public static void main(String[] args) {
        ...
        /*
         * super : 자식클래스를 이용해서 객체를 생성할 때 부모 생성자를 호출하여 부모클래스의
...
//        Product product2 = new Product("S-01234", "삼성", "갤럭시Z폴드4", 2398000, new java.util.Date());
...
//        System.out.println(computer1.getInformation());
        ...
        // Computer의 모든 필드를 초기화하는 생성자로 인스턴스
...
//        System.out.println(computer2.getInformation());
        ...
        Computer computer3 = new Computer("S-01234", "삼성", "갤럭시Z폴드4",
                2398000, new java.util.Date(), "퀄컴 스냅드래곤", 512, 12, "안드로이드");
