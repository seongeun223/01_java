...
public class Computer extends Product{
    ...
    public Computer(String s, String 삼성, String 갤럭시Z폴드4, int i, Date date, String 퀄컴_스냅드래곤, int i1, int i2, String 안드로이드) {
    }

    public String Computer(String code, String brand, String name, int price, Date manufacturingDate,
...
//                +", hdd = " + this.hdd
//                +", ram = " + this.ram
//                +", oprationSystem = " + this.operationSystem
//                +"]";
//    }
