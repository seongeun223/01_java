...
public class Application1 {
    ...
    *
    * 다형성은 객체지향 프로그래밍의 4대 특징(캡슐화, 상속, 추상화, 다형성) 중 하나이며, 활용성이 높고, 장점이 많다.
    * 하지만 학습이 어렵다.
    * */
    ...
    *    수신할 수 있다. 동일한 메세지를 수신하고 처리할 때 객체 별로 다르게 할 수 있다는
    *    장점을 가짐
    ...
    * */
    ...
    public static void main(String[] args) {
        ...
        Animal a1 = new Rabbit(); //Rabbit 타입이기도 하지만 Animal 상속받아서 Animal 타입이기도 함.
        Animal a2 = new Tiger();
...
//        a2.bite();
        ...
        // 타입 형변환을 잘못하는 경우
        // 컴파일 시 문제되지는 않지만 런타임 시 Exception 발생
        //((Tiger)a1).bite();
        ...
        * down-casting : 하위 타입으로 형변환 -> 자식클래스로 형변환
